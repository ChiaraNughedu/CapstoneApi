        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeVilla = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Immagine4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ville_Categorie_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prenotazioni_Ville_VillaId",
                        column: x => x.VillaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prenotazioni_VillaId",
                table: "Prenotazioni",
                column: "VillaId");

            migrationBuilder.CreateIndex(
                name: "IX_Ville_CategoriaId",
                table: "Ville",
                column: "CategoriaId");
        }
